                ...
                <div class="container py-6">
                    <div class="row">
                        <div class="col-lg-5 col-12 mx-auto">
                            <form class="custom-form ebook-download-form bg-white shadow" action="register/post" method="post" role="form">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <span class="input-group-text" id="basic-addon2">
                                        <i class="custom-form-icon bi-user"></i>
                                    </span>
                                </div> 
                                <div class="input-group mb-4">
                                ...
                                <div class="input-group mb-4">
                                    <input type="date" name="tahun_lulus" id="tahun_lulus" class="form-control" placeholder="tahun_lulus" required="">                                   
                                    <span class="input-group-text" id="basic-addon2">
                                        <i class="custom-form-icon bi-user"></i>
                                    </span>
                                </div>     
                                <div class="ebook-download-form-body">
                                    ...
                                    <div class="mb-3">
                                        <input type="file" class="form-control" name="image" id="image" placeholder="Image" autofocus required>
                                    </div>
